    ...
    if bot and dp:
        ...
        try:
            ...
            await bot.set_my_description(
                "«На Балансе» — твой умный ИИ-помощник по финансам. \n\n"
                "Наведи порядок в деньгах без нудных таблиц:\n"
            ...
            await bot.set_my_short_description(
                "Умный ИИ-помощник по финансам. Веди бюджет голосом, планируй конверты и закрывай долги вместе с партнером!"
            )
